...
<div class="container py-4">
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <h4 class="mb-0 fw-bold text-primary">Liste des évaluations de rattrapage</h4>
            @if(auth()->user()->role !== 'eleve')
            <a href="{{ route('evaluations.createRatt') }}" class="btn btn-sm btn-success">
                <i class="fas fa-plus me-1"></i> Ajouter un rattrapage
            </a>
            @endif
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('evaluations.rattrapage') }}" method="GET" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-4">
                ...
                <table class="table table-hover align-middle">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="fw-semibold">Date d'évaluation</th>
                    ...
                    <tbody>
                        @forelse($evaluations as $evaluation)
                            @php
                                $noteClass = '';
                                if ($evaluation->note && $evaluation->note < 10) {
                                    $noteClass = 'text-danger';
                                } elseif ($evaluation->note && $evaluation->note >= 10) {
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Êtes-vous sûr de vouloir supprimer cette évaluation de rattrapage?
                                                </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">
                                    <i class="fas fa-search me-2"></i> Aucune évaluation de rattrapage trouvée.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
